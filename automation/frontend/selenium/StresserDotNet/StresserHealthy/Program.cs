...
public class Program
{
    ...
    static void Main()
    {
        ...
        string url_base = "https://api-mng.interplayers.com.br/gip-pbm-api/api/",
        ...
        while (true)
        {
            do
            {
                ...
                if (response.Content.ToString().ToLower() == "\"w\"")
                {
                    ...
                    RegisterTime("Preview Sales Order");
                    ...
                    RegisterTime("Pre Sales Order"); // end

                    RegisterTime("Sales Order"); // start

                    {
                        ...
                        {
                            SalesOrderItems = new List<SalesOrderItem2> { new SalesOrderItem2
                            {
                                EAN = _p.Trim(),
                                ProductQuantity = _qtd,
                    ...
                    RegisterTime("Sales Order"); // end

                    RegisterTime("Sales Order Confirm"); // start
                    ...
                    RegisterTime("Sales Order Confirm"); // end
